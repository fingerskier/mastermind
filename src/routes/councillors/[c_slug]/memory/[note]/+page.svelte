...
<PageHeader title={n.title} back="/councillors/{data.c_slug}" backLabel="Councillor">
  {#snippet subtitle()}
...
<form method="POST" action="?/save" class="stack">
  ...
  <div class="actions">
    <Button href="/councillors/{data.c_slug}">Back</Button>
...
<style>
  ...
  .mono { font-family: var(--font-mono); font-size: 0.9em; resize: vertical; min-height: 20rem; }
  ...
  .actions { margin-top: 0; display: flex; gap: 0.5rem; justify-content: flex-end; }
</style>
